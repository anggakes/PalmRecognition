package palmrecognition.neural;
...
public class Backpropagator {
    ...
    public void train(TrainingDataGenerator generator, double errorThreshold) {
        ...
        do {
            ...
            System.out.println("Error for epoch " + epoch + ": " + error + ". Average: " + average + ". errorThreshold: "+ errorThreshold+(characteristicTime > 0 ? " Learning rate: " + learningRate / (1 + (currentEpoch / characteristicTime)): ""));
            epoch++;
            currentEpoch = epoch;
